...
@endif
<a href="/dashboard/sells/orders/{{ $order->id }}/edit" target="blank" class="badge bg-info"><span data-feather="printer"></span>
</a>
<br>
@if( $order->status < 1) 
<form action="/dashboard/bills" method="post" class="d-inline">
    ...
    <button class="badge bg-primary" onclick="return confirm('Anda Yakin Ingin membuat tagihan?')">Buat Tagihan</button>
</form>
